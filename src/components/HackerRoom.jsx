...
export default function HackerRoom(props) {
  ...
  const monitorTexture = useTexture(`${import.meta.env.BASE_URL}textures/desk/monitor.png`);
  const screenTexture = useTexture(`${import.meta.env.BASE_URL}textures/desk/screen.png`);
