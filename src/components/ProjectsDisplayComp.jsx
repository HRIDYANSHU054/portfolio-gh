...
export default function ProjectDisplayComp({ texture, ...props }) {
  const group = useRef();
  const { nodes, materials } = useGLTF(`${import.meta.env.BASE_URL}models/computer.glb`);
  const videoTexture = useVideoTexture(
    texture ? `${import.meta.env.BASE_URL + texture}` : `${import.meta.env.BASE_URL}textures/project/project1.mp4`,
  );
  // const videoTexture = useTexture(texture);
